        ...
        <div className={styles.AddElem}>
            <div className={styles.AddElemInnerContainer}>
                ...
                <div className={styles.AddElemButtonsContainer}>
                    <button id={styles.Add1Container} onClick={props.onClick1}>
                    <svg className={styles.Add1ElemVector} width="46" height="47" viewBox="0 0 46 47" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button id={styles.Add2Container} onClick={props.onClick2}>
                    <svg className={styles.Add2ElemVector} width="27" height="28" viewBox="0 0 27 28" fill="none" xmlns="http://www.w3.org/2000/svg">
